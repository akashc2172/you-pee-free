...
- **Baseline surrogate targets**: `ΔP`, `Q_out`, `Ex`, normalized flux centroid, normalized IQS
- **Diagnostics**: zone triplets / `CV_Qsh`, per-hole long-table metrics, QC gates (mass balance, mesh quality, convergence)
